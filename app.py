...
<body>
    <div class="container">
        <h1>💢 Wehe du lässt mich an den sicheren Tagen rausziehen 💢</h1>
        
        <div class="love-note">
            ❤️ Ich liebe dich über alles! ❤️
        </div>
        ...
        <form method="POST">
            ...
            <div class="form-group">
                <label>📅 An welchem Zyklustag hattet ihr ungeschützten Sex? (Creampie)</label>
        ...
        <div class="result">
            ...
            <div class="single-day-box">
                ...
                {% if result.single_day_percent > 20 %}
                    <p style="color: #e74c3c; font-size: 18px;">🔴 <strong>HOCHES Risiko</strong> - Du lässt mich besser nicht rausziehen!</p>
                {% elif result.single_day_percent > 8 %}
                    <p style="color: #e67e22; font-size: 18px;">🟡 <strong>MITTELES Risiko</strong> - Vorsicht, das ist kein sicherer Tag!</p>
                {% elif result.single_day_percent > 1 %}
                    <p style="color: #27ae60; font-size: 18px;">🟢 <strong>GERINGES Risiko</strong> - Aber sicher ist sicher...</p>
                {% else %}
                    <p style="color: #7f8c8d; font-size: 18px;">⚪ <strong>SEHR GERINGES Risiko</strong> - Vielleicht wirklich sicherer Tag 😏</p>
                {% endif %}
            </div>
            {% else %}
            <div class="stats">
            ...
            <div style="margin-top: 20px; padding: 12px; background: #f8f9fa; border-radius: 8px;">
                <h4>📅 Die gefährlichsten Tage (NIEMALS rausziehen lassen!):</h4>
                <ul>
        ...
        <footer>
            Basierend auf Wilcox et al. (1995) NEJM — Für dich, mein Schatz ❤️
        </footer>
    </div>
</body>
</html>
